# 文件名: robot_lib_system_chassis_arm_sensors.py
import subprocess
import time
import signal
import os
...
class Robot:
    def __init__(self):
        ...
        self.application_process = None  # 应用进程句柄
        ...
        self.robot_type = "mec"  # 默认车型
        
        # 机械臂参数
        self.arm_length_1 = 200.0  # 大臂长度 mm
        self.arm_length_2 = 150.0  # 小臂长度 mm
